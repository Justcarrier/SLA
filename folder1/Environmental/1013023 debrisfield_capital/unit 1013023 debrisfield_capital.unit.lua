return {
    unitName = "debrisfield_capital",
    unitDisplayName = "",
    unitTooltip = "",
    unitBlurb = "",
    unitBlurbExcludeFromTooltip = false,
    hotkey = "",
    picture = "1_13023_debrisfield_capital.png",
    controllable = false,
    unselectable = true,
    untargetable = true,
    unhittable = true,
    ...
    mainMesh = "01_debris_capital/01_debris_capital",
    materials = { "01_MT_BaseColour_teamColour", "01_MT_Embers" },
    unitCore = true,
    glowFade = {
        glowElement = 1,
        fadeTime = 30,
