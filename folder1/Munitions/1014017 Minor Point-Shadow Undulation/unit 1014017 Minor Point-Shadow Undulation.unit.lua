return {
    unitName = "bullet_subgregor",
    unitDisplayName = "Minor Point-Shadow Undulation",
    unitTooltip = "",
    unitBlurb = "Spatiotemporal force wave.",
    unitBlurbExcludeFromTooltip = false,
    hotkey = "",
    picture = "1_14017_bullet_subgregor.png",
    controllable = false,
    unselectable = true,
    untargetable = true,
    unhittable = true,
