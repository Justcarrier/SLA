return {
    unitName = "0x0_bullet_lightcannon",
    unitDisplayName = "",
    unitTooltip = "",
    unitBlurb = "",
    unitBlurbExcludeFromTooltip = false,
    hotkey = "",
    picture = "3_34002_0x0_bullet_lightcannon.png",
    controllable = false,
    unselectable = true,
    untargetable = true,
    unhittable = true,
    ...
    mainMesh = "bullet_lightcannon/bullet_lightcannon",
    materials = { "03_material_cannontracer" },
    parts = {
        {
            name = "warhead",
            position = { 0, 0, 0 },
